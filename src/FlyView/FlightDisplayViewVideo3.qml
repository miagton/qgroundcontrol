...
Item {
    ...
    property bool   _streamEnabled:     QGroundControl.settingsManager.videoSettings.streamEnabled3.rawValue &&
                                        QGroundControl.settingsManager.videoSettings.rtspUrl3.rawValue !== "" &&
                                        QGroundControl.settingsManager.videoSettings.rtspUrl3.rawValue.toLowerCase().startsWith("rtsp://")
