...
Item {
    ...
    PipState {
        ...
        onWindowAboutToOpen: {
            // Note: Video stream 3 doesn't control main videoManager
        ...
        onStateChanged: {
            // Video stream 3 doesn't affect full screen state
        }
    }
    ...
    //-- Video Streaming for Stream 3
    Loader {
        id:             videoStreaming3
        anchors.fill:   parent
        active:         true  // Always active when parent FlyViewVideo3 is created
        source:         "qrc:/qml/QGroundControl/FlyView/FlightDisplayViewVideo3.qml"
